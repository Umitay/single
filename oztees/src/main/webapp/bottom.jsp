<nav class="navbar navbar-default navbar-fixed-bottom" style="margin-bottom: 0px;" >
  <div class="container">
   <ul class="nav navbar-nav">
				       ...
				       href="/page/v/about"><b>About us</b></a>
				       </li>
				       <li style="display:inline-block;"><a class="capitalize"  
				       href="/page/v/customer-service"><b>Customer Service</b></a>
				       </li>
				       <li style="display:inline-block;"><a class="capitalize"  
				       href="/page/v/printing-and-embroidery-price"><b>Printing & Embroidery</b></a>
				       </li>
				       <li style="display:inline-block;"><a class="capitalize"  
