...
<%@include file="header.jsp" %>
		...
		<small class="text-muted" style="font-size: 42%; line-height: 26px; margin: 23px 0px 0px;">
				Sort By: 
				<a href="/v/${product.slug}?order_by=code">Code</a>,
				<a href="/v/${product.slug}?order_by=name">Name</a>, 
				<a href="/v/${product.slug}?order_by=brand">Brand</a>,
				<a href="/v/${product.slug}?order_by=approved_price">Price</a>, 
				<a href="/v/${product.slug}?order_by=gender">Gender</a>
			</small></h1>
        <div class="items">
